...
120 IF F(1)=0 AND C(I)=R THEN J$=J$+" "+P$+" "+O$+","
130 NEXT I
...
180 IF R=18 AND E$(18)="N" THEN J$=J$+" AN DAK DOOR," 
...
320 IF MID$(I$,I+1,1)<>" " AND V$<>"" THEN T$=MID$(1$,I+1,LEN(I$)-1):I=LEN(I$)
...
500 IF IF VB<NV AND C(B)<>0 THEN R$="YOU DO NOT HAVE THE "+T$:GOTO 30
...
840 R$="B USPMM TUPQT ZPV DSPTTJOH":GOSUB 4620: RETURN
...
1550 IF H=7432 THEN R$="UIFV BSF BQQMF USFFT":GOSUB 4620:F(5)=0
...
3390 GOSUB 3330
3340 FOR I=1 TO NO:READ T$:NEXT I
