1 PRINT "This program is still under construction."
2 PRINT "Press Y to continue at your own risk, anything else to exit: "
3 GET K$: IF UPPER$(K$) <> "Y" THEN END
...
11720  SOUND FN SN(I), FN SD(J): WAIT FN SD(J)
11730  GOTO 11710
